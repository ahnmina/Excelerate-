...
$query = "SELECT * FROM item WHERE display_name = 'Pencils'";
          ...
          <!-- Menu -->
            ...
            <?php
                ...
                while($row=mysqli_fetch_array($result)){
                  ...
                  echo '<a href="pencil.php?p_id='.$row['p_id'].'"></a>';
                  echo '<br>';
                  echo '<br>';
                  ...
                  echo '<br>';
                  echo '<br>';
                  echo '<a href="pencil.php?p_id='.$row['p_id'].'" class="btn btn-primary">Add to Cart</a>';
                  echo '<br>';
                }
            ?>
          </section>
