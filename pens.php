...
$query = "SELECT * FROM item WHERE display_name = 'pens'";
$result = mysqli_query($db, $query);

updateCartTotal($db); //update number of items in cart
	...
	<body>
		<!-- Wrapper -->
          ...
          <!-- Menu -->
            ...
            <h1><center>Stationery</center></h1>
            ...
            <?php
                ...
                while($row=mysqli_fetch_array($result)){
                  $source= '<img src="data:image/jpeg;base64,'.base64_encode( $row['picture'] ).'" height="150" width="150"/>';
                  echo $source;
                  //echo '<a href="pens.php?p_id='.$row['p_id'].'" class="btn btn-primary">Add to Cart</a>';
                  echo '<a href="pens.php?p_id='.$row['p_id'].'"></a>';
                  echo '<br>';
                  echo '<br>';
