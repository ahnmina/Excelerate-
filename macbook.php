...
$query = "SELECT * FROM item where display_name = 'Macbook'";
              ...
              <header class="major">
                ...
                <?php
                    while($row=mysqli_fetch_array($result)){
                      $source= '<img src="data:image/jpeg;base64,'.base64_encode( $row['picture'] ).'" height="150" width="300"/>';
                      echo $source;
                      //echo '<a href="macbook.php?p_id='.$row['p_id'].'" class="btn btn-primary">Add to Cart</a>';
                      echo '<a href="macbook.php?p_id='.$row['p_id'].'"></a>';
                      echo '<br>';
                      echo '<br>';
